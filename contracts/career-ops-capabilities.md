...
| Artifact identity/provenance/freshness | Canonical report/tracker identity plus HFW's private committed preparation manifest; generic PDF-index/output files still lack sufficient provenance | Conditional | `artifacts.inspect.v1` reuses the canonical report and only exact hash-bound HFW bundles at the probed revision. It refreshes unproven career-ops CV/PDF output and does not claim structured source-backed change provenance. |
