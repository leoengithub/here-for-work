...
export const applicationsPreviewDashboard: DashboardState = {
  ...
  preparations: [
    ...
    preparation("failed", "Senior React Frontend Developer", "BCNC Group", "action_required", "preparing_cv", {
      ...
      retryPolicy: "retry_same_preparation",
    }),
    preparation("fact-check-failed", "Staff Frontend Engineer", "Wizeline", "action_required", "preparing_cv", {
...
export const queuePreviewDashboard: DashboardState = {
  ...
  preQueueRoles: [
    ...
    {
      roleId: "attention-skip",
      company: "Harbor Labs",
      title: "Staff Frontend Engineer",
      applicationUrl: "https://example.test/attention-skip/apply",
      state: "needs_attention",
      reason: "canonical_status_not_evaluated",
      recovery: { scope: "repair_career_ops", action: "repair_career_ops" },
      attempt: 1,
      updatedAt: now,
    },
    {
      roleId: "attention-stale",
      company: "Example Studio",
      title: "UI Engineer",
      applicationUrl: "https://example.test/attention-stale/apply",
      state: "needs_attention",
    ...
    {
      roleId: "attention-history",
      company: "Northstar Tools",
      title: "Product Engineer",
      applicationUrl: "https://example.test/attention-history/apply",
      state: "needs_attention",
      reason: "canonical_history_unavailable",
      recovery: { scope: "global_reconcile", action: "reconcile_application_history" },
      attempt: 2,
      updatedAt: now,
    },
